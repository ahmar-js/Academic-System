...
urlpatterns = [
    ...
    path('add_post/', HodViews.add_post, name="add_post"),
    path('add_post_save/', HodViews.add_post_save, name="add_post_save"),
    path('manage_post/', HodViews.manage_post, name="manage_post"),

    path('edit_post/<post_id>', HodViews.edit_post, name="edit_post"),
    path('edit_post_save/', HodViews.edit_post_save, name="edit_post_save"),
    path('delete_post/<post_id>/', HodViews.delete_post, name="delete_post"),
