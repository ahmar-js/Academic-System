...
class EditStudentForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Dynamically populate the course choices
        try:
            courses = Courses.objects.all()
        ...
        # Dynamically populate the session year choices
        try:
            session_years = SessionYearModel.objects.all()
            session_year_list = [
        ...
        self.fields['course_id'] = forms.ChoiceField(label="Course", choices=course_list, widget=forms.Select(attrs={"class": "form-control"}))
        self.fields['session_year_id'] = forms.ChoiceField(label="Session Year", choices=session_year_list, widget=forms.Select(attrs={"class": "form-control"}))
